...
public class SampleSearch {
     ...
     */
    private static Collection<Sample> searchByParameter(String userId, ExtractedJPQL ejpql, int startIndex, int numberResults, EntityManager manager)  {
        try {
     ...
     */
     public static Collection<Sample> searchByParameterListComparators(String userId, List<ParameterComparator> listComparators, int startIndex, int numberResults, EntityManager manager) throws ParameterSearchException  {
      ...
      */
     public static Collection<Sample> searchByParameterOperable(String userId, ParameterOperable parameterOperable, int startIndex, int numberResults, EntityManager manager) throws ParameterSearchException {
      ...
      * @throws ParameterSearchException
      */
    public static Collection<Sample> searchByParameterOperable(String userId, ParameterOperable parameterOperable, EntityManager manager) throws ParameterSearchException {
        ExtractedJPQL ejpql = ParameterSearchUtilSingleton.getInstance().extractJPQLOperable(parameterOperable);
     ...
     * @throws ParameterSearchException
     */
    public static Collection<Sample> searchByParameterListParameter(String userId, List<ParameterValued> listParam, int startIndex, int numberResults, EntityManager manager) throws NoParameterTypeException, EmptyListParameterException, NoSearchableParameterException, NoParametersException, NullParameterException {
