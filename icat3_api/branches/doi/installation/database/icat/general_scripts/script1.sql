...
(
  FACILITY_USER_ID VARCHAR2(255 BYTE) NOT NULL 
...
, FULL_REFERENCE VARCHAR2(4000 BYTE) NOT NULL 
...
, SAFETY_INFORMATION VARCHAR2(4000 BYTE) NOT NULL 
...
(
  APP_CODE VARCHAR2(10 BYTE) NOT NULL 
...
, INVESTIGATION_ID NUMBER NOT NULL 
, NAME VARCHAR2(255 BYTE) NOT NULL 
, DATASET_TYPE VARCHAR2(255 BYTE) NOT NULL 
...
, RELATION VARCHAR2(255 BYTE) NOT NULL 
, MOD_TIME TIMESTAMP(1) NOT NULL 
, MOD_ID VARCHAR2(255 BYTE) NOT NULL 
, CREATE_TIME TIMESTAMP(1) NOT NULL 
, CREATE_ID VARCHAR2(255 BYTE) NOT NULL 
...
, INVESTIGATION_ID NUMBER NOT NULL 
, INVESTIGATION_VISIT_ID VARCHAR2(255 BYTE) NOT NULL 
, MOD_ID VARCHAR2(255 BYTE) NOT NULL 
, MOD_TIME TIMESTAMP(1) NOT NULL 
, CREATE_TIME TIMESTAMP(1) NOT NULL 
, CREATE_ID VARCHAR2(255 BYTE) NOT NULL 
...
, CREATE_TIME TIMESTAMP(1) NOT NULL 
, CREATE_ID VARCHAR2(255 BYTE) NOT NULL 
, FACILITY_ACQUIRED VARCHAR2(4000 BYTE) NOT NULL 
, DELETED VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
...
, ACTION_INSERT VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_INSERT_WEIGHT NUMBER NOT NULL 
, ACTION_SELECT VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_SELECT_WEIGHT NUMBER NOT NULL 
, ACTION_DOWNLOAD VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_DOWNLOAD_WEIGHT NUMBER NOT NULL 
, ACTION_UPDATE VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_UPDATE_WEIGHT NUMBER NOT NULL 
, ACTION_DELETE VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_DELETE_WEIGHT NUMBER NOT NULL 
, ACTION_REMOVE VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_REMOVE_WEIGHT NUMBER NOT NULL 
, ACTION_ROOT_INSERT VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_ROOT_INSERT_WEIGHT NUMBER NOT NULL 
, ACTION_ROOT_REMOVE VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_ROOT_REMOVE_WEIGHT NUMBER NOT NULL 
, ACTION_SET_FA VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_SET_FA_WEIGHT NUMBER NOT NULL 
, ACTION_MANAGE_USERS VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
, ACTION_MANAGE_USERS_WEIGHT NUMBER NOT NULL 
, ACTION_SUPER VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL 
...
(
  FACILITY_SHORT_NAME VARCHAR2(30 BYTE) NOT NULL 
...
, SEARCHABLE VARCHAR2(1 BYTE) NOT NULL 
, NUMERIC_VALUE VARCHAR2(1 BYTE) NOT NULL 
, NON_NUMERIC_VALUE_FORMAT VARCHAR2(255 BYTE) 
, IS_SAMPLE_PARAMETER VARCHAR2(1 BYTE) NOT NULL 
, IS_DATASET_PARAMETER VARCHAR2(1 BYTE) NOT NULL 
, IS_DATAFILE_PARAMETER VARCHAR2(1 BYTE) NOT NULL 
, DESCRIPTION VARCHAR2(4000 BYTE) 
, VERIFIED VARCHAR2(1 BYTE) NOT NULL 
, SEQ_NUMBER NUMBER DEFAULT 999 NOT NULL 
, MOD_ID VARCHAR2(255 BYTE) NOT NULL 
, MOD_TIME TIMESTAMP(1) NOT NULL 
, CREATE_TIME TIMESTAMP(1) NOT NULL 
...
(
  INSTRUMENT_NAME VARCHAR2(255 BYTE) NOT NULL 
, FEDERAL_ID VARCHAR2(255 BYTE) NOT NULL 
, SEQ_NUMBER NUMBER DEFAULT 999 NOT NULL 
, MOD_TIME TIMESTAMP(1) NOT NULL 
, MOD_ID VARCHAR2(255 BYTE) NOT NULL 
, CREATE_TIME TIMESTAMP(1) NOT NULL 
...
CREATE INDEX KEYWORD_INDEX1 ON KEYWORD (INVESTIGATION_ID ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX KEYWORD_INDEX3 ON KEYWORD (NAME ASC, DELETED ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX KEYWORD_INDEX4 ON KEYWORD (INVESTIGATION_ID ASC, LOWER(NAME) ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX INVESTIGATION_INDEX1 ON INVESTIGATION (INV_END_DATE ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX DATAFILE_INDEX1 ON DATAFILE (DATASET_ID ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX DATAFILE_INDEX2 ON DATAFILE (LOWER(NAME) ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX ICAT_AUTHORISATION_INDEX1 ON ICAT_AUTHORISATION (ELEMENT_ID ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX ICAT_AUTHORISATION_INDEX2 ON ICAT_AUTHORISATION (USER_ID ASC, ROLE ASC, ELEMENT_ID ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX ICAT_AUTHORISATION_INDEX3 ON ICAT_AUTHORISATION (ELEMENT_ID ASC, USER_ID ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
...
CREATE INDEX ICAT_ROLE_INDEX1 ON ICAT_ROLE (ACTION_SELECT ASC) 
LOGGING 
TABLESPACE "USERS" 
PCTFREE 10 
INITRANS 2 
