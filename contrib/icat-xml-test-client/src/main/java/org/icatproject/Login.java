...
public class Login {
    ...
    public static class Credentials {
        ...
        protected List<Login.Credentials.Entry> entry;
         ...
         * {@link Login.Credentials.Entry }
         * 
         * 
         */
        public List<Login.Credentials.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<Login.Credentials.Entry>();
            }
            return this.entry;
        }
