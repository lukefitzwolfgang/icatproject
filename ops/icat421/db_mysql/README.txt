...
2) ./vars contains the usernames and passwords for the MySQL database admin,
   the two database users that need to be created for ICAT and the test ICAT
   user. If you make any changes please make sure these are reflected in both
   of the glassfish.props files in this directory.
