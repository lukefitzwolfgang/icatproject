ALTER TABLE INVESTIGATION_DOI DISABLE CONSTRAINT INVESTIGATION_DOI_INVESTI_FK1;
...
ALTER TABLE DATAFILE_DOI  DISABLE CONSTRAINT DATAFILE_DOI_DATAFILE_FK1;
...
ALTER TABLE DATASET_DOI       DISABLE CONSTRAINT DATASET_DOI_DATASET_FK1;
...
ALTER TABLE DATASET       DISABLE CONSTRAINT PK_DS;
...
ALTER TABLE DOI                 DISABLE CONSTRAINT DOI_DOI_SERVER_FK1;
...
TRUNCATE TABLE INVESTIGATION_DOI;
TRUNCATE TABLE DATASET_DOI;
TRUNCATE TABLE DATAFILE_DOI;
TRUNCATE TABLE DOI;
TRUNCATE TABLE DOI_SERVER;
...
ALTER TABLE INVESTIGATION_DOI ENABLE CONSTRAINT INVESTIGATION_DOI_INVESTI_FK1;
...
ALTER TABLE DATASET_DOI       ENABLE CONSTRAINT DATASET_DOI_DATASET_FK1;
...
ALTER TABLE DATASET       ENABLE CONSTRAINT PK_DS;
...
ALTER TABLE USER_ROLES          ENABLE CONSTRAINT USER_ROLES_APPLICATIONS_FK1;
ALTER TABLE DOI                 ENABLE CONSTRAINT DOI_DOI_SERVER_FK1;
commit;
