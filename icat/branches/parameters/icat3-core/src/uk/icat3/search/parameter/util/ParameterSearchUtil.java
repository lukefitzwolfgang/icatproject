...
public class ParameterSearchUtil {
    ...
    private void extractJPQLComparator (ParameterComparisonCondition comp, ExtractedJPQLPriva ejpql) throws NoParameterTypeException, NoStringComparatorException, NoSearchableParameterException, NullParameterException, NoNumericComparatorException, NoDatetimeComparatorException, DatevalueException, NumericvalueException, DatevalueFormatException {
        ...
        if (comp.getValue().getClass() == ParameterValued.class) {
            ...
            comp.setStringValue(paramNameVal + "." + ((ParameterValued) comp.getValue()).getValueType());
        }
...
//               ejpql.addCondition(this.getCondition(paramName + "." + comp.getParameterValued().getValueType(), comp));
     ...
     * @throws ParameterNoExistsException
     */
    public ExtractedJPQL extractJPQLParameters(List<ParameterValued> listParameters, EntityManager manager) throws NoParameterTypeException, EmptyListParameterException, NoSearchableParameterException, NullParameterException, ParameterNoExistsException {
        checkList(listParameters);
        for (ParameterValued parameterValued : listParameters)
     ...
     *
     * @param paramV ParameterValued contained parameter
     * @param manager Entity Manager to database
     * 
     * @throws ParameterNoExistsException
     * @throws NoSearchableParameterException
     ...
     * @throws NoParameterTypeException
     */
    private void checkParameter (ParameterValued paramV,EntityManager manager) throws ParameterNoExistsException, NoSearchableParameterException, NullParameterException, NoParameterTypeException {
        if (paramV == null)
